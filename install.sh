...
sudo rm -rf wand
git clone --recurse-submodules --config submodule.vanilla-media.update=checkout --config submodule.legacy-media.update=checkout https://github.com/iiikrrish555/wand /home/ubuntu/wand && cd wand
