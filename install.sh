...
# Clear out any broken wand leftovers from a failed download attempt
sudo rm -rf wand

# Clone files and switch directories reliably
git clone --recurse-submodules https://github.com
cd wand

echo "Done Downloading the game files."

# Ensure .env is cleared if it somehow exists
sudo rm -f .env
